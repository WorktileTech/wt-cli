    ...
    router.post('/api/upgrade', verifyTokenMiddleware, function *(next) {
        ...
        try {
            if (!body.version || !body.upgradeVersions || !body.images || !body.services || !body.registryUsername || !body.registryPassword) {
                ...
                //开始执行升级程序
                let bashResults = yield startUpgrade(scripts, body.images, body.services, config.version, body.upgradeVersions, body.registryUsername, body.registryPassword, body.config);
