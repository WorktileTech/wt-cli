...
module.exports = function (port) {
    ...
    router.post('/api/upgrade', verifyTokenMiddleware, function *(next) {
        try {
            ...
            if (!body.version || !body.upgradeVersions || !body.images || !body.services) {
    ...
    router.get('/logs/download', function *() {
        ...
        yield send(this, 'log.log', {root: path.resolve(__dirname, '../logs')});
